...
@section('title', 'Log In - Nordic Pure Nutrition')

@section('content')
<div class="min-h-screen flex">
    {{-- Left: Decorative --}}
    <div class="hidden lg:flex lg:w-1/2 bg-[#1C1C1C] items-center justify-center p-16 relative overflow-hidden">
        <img src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=900&q=80" alt="Scandinavian interior" class="absolute inset-0 w-full h-full object-cover opacity-40">
        <div class="relative z-10 max-w-md text-center">
            <h2 class="font-serif text-4xl text-white mb-4 leading-tight italic">"The best rooms have something to say about the people who live in them."</h2>
            <p class="text-sm text-[#D8C3A5] tracking-widest uppercase">Nordic Pure Nutrition</p>
        </div>
    </div>
    {{-- Right: Form --}}
    <div class="flex-1 flex items-center justify-center p-8 sm:p-12 bg-[#FAF8F3]">
        <div class="w-full max-w-md">
            ...
            <p class="text-sm text-[#777777] mb-8">Sign in to your NordicHome account.</p>
            ...
            <div class="mt-8 pt-6 border-t border-[#E5E0D8]">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <button type="button" onclick="document.getElementById('email').value='admin@nordichome.test';document.getElementById('password').value='password';"
                        class="text-xs border border-[#E5E0D8] rounded px-3 py-2 text-[#333333] hover:bg-white">Admin Login</button>
                    <button type="button" onclick="document.getElementById('email').value='customer@nordichome.test';document.getElementById('password').value='password';"
