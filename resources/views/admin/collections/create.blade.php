...
<div class="max-w-2xl space-y-6">
    <h1 class="font-serif text-2xl text-[#1C1C1C]">Create Collection</h1>

    <form action="{{ route('admin.collections.store') }}" method="POST" enctype="multipart/form-data" class="bg-white border border-[#E5E0D8] rounded p-6 space-y-4">
        @csrf
        <div>
        ...
        <div>
            <label class="block text-xs font-semibold uppercase tracking-wider text-[#333333] mb-1">Collection Image</label>
        ...
        <div class="pt-4 flex items-center space-x-4 border-t border-[#E5E0D8]">
            <button type="submit" class="btn-primary text-xs">Save Collection</button>
